  ...
  return (
    <section className="w-full my-60 flex flex-col">
      ...
      <div className="p-6 flex flex-col gap-6 border rounded-lg rounded-t-2xl border-white/10 bg-white/10 backdrop-blur-xl shadow">
        <div className="h-16">
          <Marquee className="rounded-lg" autoFill speed={20}>
            <svg
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g fill="#18181b" clip-path="url(#akarIconsHtmlFill0)">
        ...
        <div className="h-16">
          <Marquee className="rounded-lg" autoFill direction="right" speed={20}>
            <svg
              className="ml-10 drop-shadow"
              height="60"
              viewBox="0 0 27 24"
