  ...
  return (
    <section className="w-full mt-36 mb-60 flex flex-row lg:flex-nowrap flex-wrap justify-between items-center gap-6 select-none">
      ...
      <div className="w-8/12 flex flex-col gap-6">
        {/* text box */}
        <div className="p-6 flex flex-col items-center gap-6 text-center bg-white/10 backdrop-blur-xl border border-white/10 rounded-lg drop-shadow shadow-md">
          <h1 className="text-7xl font-semibold tracking-tight">
            {heroData.h1a}
            <span className="font-normal italic">{heroData.h1b}</span>
          </h1>
          <h3 className="text-2xl font-bold">{heroData.h3}</h3>
      ...
      <div className="relative">
        <Image
          className="w-full border border-white/10 rounded-lg shadow-md"
          src={dp}
          alt="Yash Dhakad DP"
          height={dpSize}
        />
