  ...
  return (
    <section className="w-full my-60 flex flex-col gap-6">
      ...
      <Marquee speed={80} autoFill>
        <h2 className="mr-4 text-slate-200/20 text-7xl tracking-tighter font-bold uppercase overflow-hidden">
          {heading}
        </h2>
      </Marquee>
      {/* divider */}
                ...
                {project.projectTagsArr.map((fields) => {
                  return (
                    <div className="flex flex-col gap-1">
                      <p className="self-start text-xs font-medium opacity-60">
                        {fields.title}
                      </p>
