...
const Project = (props) => {
  return (
    props.projectsArr.map((project, index) => {
      return <div key={index} className={`p-6 border border-zinc-300 rounded-lg ${index === 0 ? "lg:col-span-2 lg:row-span-2" : ""} shadow-md shadow-zinc-800/20 font-["Rollerscript"] text-xl text-zinc-700 flex flex-col justify-between space-y-6`}>
